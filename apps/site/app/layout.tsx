...
export const metadata: Metadata = {
  title: "DeskCrafter - Linux Desktop Tools Suite",
  description:
    "Inspect and manage Linux launchers, autostart entries, AppImages, PATH, services, cache, permissions, and system profile checks from one local-first desktop suite.",
  icons: {
